...
class STPLTester:
    ...
    def test_single_graph(self, G, timestamp, num_pairs=5, parent_id=None,
                          ops=None, bug_dir=None):
        total_discrepancies = []
        ...
        for _ in range(num_pairs):
            ...
            if discrepancy_msg and len(G.nodes()) < 20:
                if bug_dir:
                    save_bug(discrepancy_graph, timestamp, parent_id, ops,
                             bug_dir, discrepancy_msg)
