...
class MaxMatchingFuzzer(BaseFuzzer):
    def __init__(self, *args, **kwargs):
        ...
        self.set_interesting_check(self.matching_cardinality_interesting_check)
    ...
    def matching_cardinality_interesting_check(self, result):
        return len(result) // 2
    ...
    def process_test_results(self, mutated_graph, tester, first_occurrence_times,
                             ...
                             ops=None):
        discrepancy_msg, _ = tester.test_single_graph(
